...
public class CompleteInfo extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        facultad.setDisabledTextColor(new java.awt.Color(255, 255, 255));
        facultad.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        facultad.setModoMaterial(true);
        facultad.setPlaceholder("Ingresa una facultad");
        facultad.setSelectedTextColor(getBackground());
        facultad.setSelectionColor(new java.awt.Color(102, 102, 102));
        facultad.setSoloLetras(true);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(facultad, javax.swing.GroupLayout.PREFERRED_SIZE, 413, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void boton_continuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_continuarActionPerformed
        if (facultad.getText().isEmpty()) {
            showMessageDialog(null, "Ingresa tu facultad.");
        }
        String textFacultad = facultad.getText();

        ConnectionService connection = new ConnectionService();
        connection.actualizarAlumno(textFacultad, matr);
